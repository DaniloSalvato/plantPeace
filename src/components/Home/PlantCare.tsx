  ...
  return (
    <main className=" w-full mt-24  bg-customWhite">
      ...
      <section className="mb-20 flex flex-col justify-center items-center text-center gap-4">
        ...
        <p className=" font-raleway text-customGray text-base w-2/3 leading-7">By following these three steps - proper watering, appropriate sunlight, and providing essential nutrients - you'll be well on your way to maintaining healthy and thriving plants.</p>
      </section>
      ...
      <section className="flex flex-col gap-20 justify-center items-center mb-24 xl:flex-row xl:items-start">
        <div className="flex flex-row gap-5 justify-center items-center xl:flex-row xl:gap-20">
          <img src={imgFirst} className="w-2/5 transition-all hover:shadow-2xl hover:scale-110 md:w-80 xl:w-96" />
          <img src={imgSecond} className="w-2/5 transition-all hover:shadow-2xl hover:scale-110 md:w-80 xl:w-96" />
        </div>
        ...
        <div className="flex flex-col items-center gap-6 mx-3 xl:m-0 xl:max-w-sm lg:max-w-2xl md:max-w-2xl sm:max-w-2xl xl:items-start">
          <img src={imgThird} className="w-full transition-all hover:shadow-2xl hover:scale-110" />
