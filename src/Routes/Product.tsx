...
export default function Product() {
  return (
    <main className="bg-customWisper flex flex-col lg:flex-row *:flex-1 justify-center items-center gap-16 p-4">
      <img className="size-full object-cover" src={cactus} alt="Cactus plant" />

      <section className="flex flex-col items-start gap-8 mb-4">
